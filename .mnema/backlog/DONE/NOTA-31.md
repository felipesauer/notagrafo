...
mnema:
  ...
  description: >-
    ...
    dashboard/grafo; variáveis de ambiente; como contribuir), CONTRIBUTING.md
    (rodar localmente, testes, Conventional Commits, PR) e LICENSE (MIT).
    Validar o quickstart ponta a ponta.
  acceptance_criteria:
  ...
  reopen_count: 0
  metadata: {}
  updated_at: '2026-06-27T17:54:03.266Z'
---
