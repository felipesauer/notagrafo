...
export const ptBR = {
    ...
    rede: {
        ...
        vazioFluxoDescricao: 'Importe NF-e entre empresas para visualizar o fluxo de valor entre elas.',
        vazioRedeDescricao: 'Importe NF-e para ver a rede de relações comerciais entre as empresas da base.',
